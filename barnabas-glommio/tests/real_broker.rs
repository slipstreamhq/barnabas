...
async fn plain_records_round_trip() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn a_commit_after_an_abort_survives() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn read_uncommitted_sees_aborted_records() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn seek_positions_the_next_fetch() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn fetches_are_routed_to_the_partition_leader() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn prefetch_returns_the_same_records() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn a_seek_discards_the_fetch_already_in_flight() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn batch_filtering_drops_only_the_aborted_transaction() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn offset_lookups_describe_the_log() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn offsets_for_times_finds_the_first_record_at_or_after() {
...
#[glommio::test]
#[ignore = "needs a Kafka broker on localhost:9092"]
async fn pausing_stops_a_partition_without_losing_its_place() {
